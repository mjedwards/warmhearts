    ...
    <div className="flex flex-col">
      ...
      <div className="">
        <div className="flex flex-col lg:flex-row col-span-5 h-full mt-11">
          <TextContainer title="About Us" subtitle="Our Mission" description={descriptions[0]} tagline={taglines[0]} pathname="/Who-We-Are" />
        ...
        <div className="flex flex-col lg:flex-row lg:flex-row-reverse col-span-5 h-full mt-11">
          <TextContainer title="What We Do" subtitle="Our Vision" description={descriptions[1]} tagline={taglines[1]} pathname="/" />
