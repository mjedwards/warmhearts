            ...
            <div className="text-center">
              ...
              <p className="mx-auto mt-3 max-w-md text-base text-gray-500 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl">
                <p className="leading-loose text-sm lg:text-lg lg:px-40 lg:p-8">
                  Our mission is, through mentorship, to empower youth from
                  social and economically disadvantaged communities to become
                  academically fit people of high character and strong
                  self-esteem who are emotionally stable and free of high-risk
                  behaviors.
                </p>
              </p>
            </div>
