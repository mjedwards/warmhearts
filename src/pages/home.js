...
export default function HomePage() {
	...
	return (
		<div className='min-h-screen'>
			...
			<div
				...
				<div className='relative z-5 max-w-6xl mx-auto px-6 text-center text-white'>
					<h1 className='text-5xl md:text-7xl font-bold mb-8 leading-tight'>
						<span style={{ color: "#ec523d" }}>Inspiring</span> hope and leaving
						a positive
						<br />
					...
					<div className='flex flex-col items-center justify-center mt-12'>
						...
						<div className='flex flex-col sm:flex-row gap-4'>
							<Link
								to='/about'
								className='text-white px-8 py-4 rounded-full font-semibold text-lg transition-colors duration-200 min-w-[160px] inline-block text-center'
				...
				<div className='max-w-6xl mx-auto px-6'>
					<div className='text-center mb-12'>
						<div className='w-24 h-24 flex items-center justify-center mx-auto mb-6'>
							<img
								src='/mentorWithWords.png'
								alt='Warmhearts Mentorship Logo'
								className='w-20 h-20'
							/>
						</div>
					...
					<div className='grid md:grid-cols-3 gap-8'>
						...
						<div className='bg-white rounded-3xl shadow-lg overflow-hidden'>
							<div className='relative'>
								...
								<div className='absolute bottom-0 left-0 right-0 bg-white rounded-t-3xl p-4'>
									<div className='flex items-center gap-2'>
										<h3 className='text-xl font-medium text-gray-800 text-left'>
											Our Mission
										</h3>
										<img
											src='/mission.png'
							...
							<div className='p-6 text-left'>
								<p className='text-gray-700 text-base leading-relaxed mb-5'>
									Through mentorship, we empower our youth from social and
						...
						<div className='bg-white rounded-3xl shadow-lg overflow-hidden'>
							...
							<div className='p-6 text-left'>
								<p className='text-gray-700 text-base leading-relaxed mb-5'>
									We aim to inspire and empower youth for greatness, leaving a
									positive impact on our communities.
								</p>
								<p className='font-semibold text-gray-900 text-sm'>
									Planting Seeds of Hope, Cultivating Greatness: Shaping
			...
			<div
				className='relative'
				style={{ backgroundColor: "#1f2937", "--divider-height": "20rem" }}>
				...
				<div
					...
					<svg
						...
						preserveAspectRatio='none'>
						<path
							d='M0 0v4c250 0 250 96 500 96S750 4 1000 4V0H0Z'
							fill='#F3F4F6'></path>
					</svg>
				</div>
					...
					<div className='max-w-6xl mx-auto'>
						...
						<div className='relative z-10 mb-16 text-center'>
							<h2 className='text-6xl font-bold mb-12'>
								<span style={{ color: "#ec523d" }}>Showing</span>{" "}
								<span style={{ color: "#1F2937" }}>Up and</span>
								<br />
								<span style={{ color: "#ec523d" }}>Standing</span>{" "}
								<span style={{ color: "#1F2937" }}>Out</span>
							</h2>
						</div>
						...
						<div
							...
							style={{ marginTop: "calc(var(--divider-height) - 8rem)" }}>
							<div className='text-white'>
								<p className='text-gray-300 leading-relaxed mb-6'>
									Education is a cornerstone of our program. We are committed to
									supporting our children as they strive to advance to the next
									grade. Recognizing that they do not get to choose where they
									go to school, it is our responsibility to guide them and help
									them improve on their educational journey.
								</p>
								<p className='text-gray-300 leading-relaxed'>
									Throughout our program's history, we've witnessed consistent
									growth and improvement among our students. As they transition
									to the next grade, they continue to excel on the FSA exam,
									achieving scores ranging from level 3 to 5. These scores are
									indicative of their proficiency in both reading and math.
								</p>
							</div>
							...
							<div className='text-white border-l-2 border-gray-600 pl-8'>
								<div className='mb-8'>
									...
									<p className='text-gray-400 text-sm leading-relaxed mt-2'>
										Additionally, our eighth graders are transitioning to high
										school, successfully completing their classes and current
										grade.
									</p>
								</div>
								<div>
									...
									<p className='text-gray-400 text-sm leading-relaxed mt-2'>
										All sixth and seventh-grade students are advancing to the
										next level. Additionally, our eighth graders are
										transitioning to high school, successfully completing their
										classes and current grade.
									</p>
								</div>
							</div>
						</div>
								...
								<div className='flex flex-col lg:flex-row lg:items-start gap-8'>
									...
									<div className='text-white flex-1 text-left text-center lg:text-left'>
										...
										<p className='text-sm leading-relaxed text-left'>
											We monitor school attendance closely as a key indicator of
											a child's academic progress and holistic growth.
											Consistent attendance guarantees access to learning,
											nurtures social and emotional development, and cultivates
											essential life skills. Chronic absenteeism, however, can
											result in learning gaps, diminished academic performance,
											and reduced engagement. Thus, prioritizing and advocating
											for regular attendance is paramount for every child to
							...
							<div>
								<div className='flex flex-col lg:flex-row lg:items-start gap-8'>
									...
									<div className='text-white flex-1 text-left text-center lg:text-left'>
										...
										<p className='text-sm leading-relaxed text-left'>
											Monitoring behavioral improvement in school is vital for a
											child's overall development and academic success. Tracking
											behavior helps identify areas of growth and ensures a
											supportive learning environment. Positive behavior fosters
											engagement, collaboration, and a conducive atmosphere for
											learning. On the other hand, addressing behavioral
											challenges early can prevent disruptions, promote
											social-emotional skills, and enhance peer relationships.
											Prioritizing behavioral improvement supports students in
											achieving their full potential academically and socially.
										</p>
									</div>
								</div>
							</div>
			...
			<div
				...
				<div className='relative z-10 max-w-4xl mx-auto px-6 text-center'>
					...
					<h3 className='text-5xl font-bold mb-12' style={{ color: "#1F2937" }}>
					...
					<div className='grid md:grid-cols-2 gap-16 items-center'>
						<div className='text-white text-left'>
							...
							<p className='text-gray-300 leading-relaxed mb-8 text-left'>
								Supporting families and engaging with the community are
								essential aspects of Warmheart Mentorship Service. Our
								commitment to these activities underscores the importance of a
								strong support system for the children we serve. Also, hosting
								events to recognize the contributions of our volunteers not only
								highlights their invaluable role but also reinforces our
								collective mission. Maintaining these engagements is crucial as
								they foster a sense of unity, celebrate achievements, and
								amplify the positive impact on families. By prioritizing family
								support, Warmheart Mentorship ensures a nurturing and thriving
